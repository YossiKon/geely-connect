...
(() => {
  ...
  const STR = {
    ...
    it: {
      "action.charging": "Ricarica",
      "action.climate": "Clima",
      "action.close": "Chiudi",
      "action.confirm_tap": "sicuro?",
      "action.defrost": "Sbrinamento",
      "action.find": "Trova",
      "action.lock": "Blocca",
      "action.open": "Apri",
      ...
      "chip.n_open": "{count} aperti",
      "chip.parked": "Parcheggiata",
      "chip.plugged_in": "Collegata",
      "chip.unlocked": "Sbloccata",
      "label.battery_fuel_pct": "{batt}% · {fuel}% carburante",
      "label.driver": "Guidatore",
      "label.electric_range": "Autonomia elettrica",
      "label.end": "Fine",
      "label.ev_short": "{n} elettrico",
      "label.fresh_air": "Aria fresca",
      "label.fuel_short": "{n} carburante",
      "label.hood": "Cofano",
      "label.inside": "interno",
      "label.maps": "Mappe",
      "label.parking_comfort": "Comfort parcheggio",
      "label.passenger": "Passeggero",
      "label.range": "Autonomia",
      "label.seat_cooling": "Ventilazione sedile",
      "label.seat_heat": "Riscaldamento sedile",
      "label.shade": "Tendina",
      "label.start": "Inizio",
      "label.sunroof": "Tettuccio",
      "label.synced": "Sincronizzato {time}",
      ...
      "level.medium": "Medio",
      "level.off": "Spento",
      "row.battery_12v": "Batteria 12 V",
      "row.charger": "Caricatore",
      "row.combined_range": "Autonomia combinata",
      "row.complete_at": "Completa alle",
      "row.efficiency": "Efficienza",
      "row.engine": "Motore",
      "row.fuel_level": "Livello carburante",
      "row.fuel_range": "Autonomia carburante",
      "row.lifetime_avg": "Media complessiva",
      "row.odometer": "Contachilometri",
      "row.pack_power": "Potenza pacco batteria",
      "row.power": "Potenza",
      "row.range_at_full": "Autonomia al 100%",
      "row.schedule": "Programmazione",
      "row.service_in": "Tagliando tra",
      "row.time_to_full": "Tempo a piena carica",
      "row.trip_meter": "Contachilometri parziale",
      "section.charging": "Ricarica",
      "section.fuel": "Carburante",
      "section.navigate": "Naviga verso l'auto",
      "section.seat_cooling": "Ventilazione sedili",
      "section.seat_heating": "Riscaldamento sedili",
      "section.tires": "Pneumatici",
      "section.trip_health": "Viaggio e salute",
      "status.charging_line": "In carica{power}",
      "status.driving_body": "I comandi remoti non sono disponibili finché l'auto non è parcheggiata",
      "status.driving_line": "In marcia{speed}",
      "status.driving_locked": "In marcia · comandi bloccati",
      "status.driving_title": "In marcia",
      "status.n_openings_open": "{count} apertur{plural} aperte",
      "status.no_vehicle_body": "Nessun veicolo Geely trovato. Imposta <code>prefix:</code> con il tuo suffisso entità, es. <code>my_geely_ex5</code> per <code>sensor.my_geely_ex5_battery</code>.",
      "status.no_vehicle_title": "Geely Connect",
      "status.parked_locked": "Parcheggiata · Bloccata",
      "status.render_failed": "Rendering non riuscito: {error}",
      "tooltip.charging_toggle": "Avvia / interrompi la ricarica",
      "tooltip.cooler": "Più fresco",
      "tooltip.cover_close": "Chiudi {label}",
      "tooltip.cover_open": "Apri {label}",
      "tooltip.fresh_air": "Aria fresca (G-Clean)",
      "tooltip.lifetime_avg": "Media dall'acquisto dell'auto. Lo schermo dell'auto di solito mostra il viaggio corrente, che risulta più basso - quella è l'entità Consumo Viaggio, non questa.",
      "tooltip.navigate_with": "Naviga verso l'auto con {app}",
      "tooltip.open_the_full_card": "Apri la scheda completa",
      "tooltip.parking_comfort": "Comfort parcheggio: mantiene confortevole l'abitacolo mentre l'auto è parcheggiata. La tua auto non segnala se è attivo, quindi questo pulsante lo commuta senza mostrare uno stato.",
      "tooltip.rapid_cool": "Raffreddamento rapido: il preset dell'auto - porta il setpoint al minimo, ventila entrambi i sedili anteriori e abbassa leggermente i finestrini",
      "tooltip.rapid_heat": "Riscaldamento rapido: il preset dell'auto - porta il setpoint al massimo e riscalda entrambi i sedili anteriori, oltre al volante dove presente",
      "tooltip.schedule_toggle": "Ricarica programmata on / off",
      "tooltip.trunk_release": "Sblocca il fermo {word} - non lo apre elettricamente. Sollevalo a mano, o usa il telecomando, entro pochi secondi prima che si blocchi di nuovo da solo.",
      "tooltip.warmer": "Più caldo",
      "tooltip.wheel_heat": "Riscaldamento volante on / off. Confermato su un'auto reale; la lettura è lenta, quindi il pulsante mantiene lo stato per un momento.",
      "topview.closed": "Chiuso",
      "topview.open": "Aperto",
      "topview.unknown": "—",
    },
  };
